...
const runTelemetryMutation = async (label, mutation) => {
...
export class VoiceTelemetryApplication {
    static async markSessionLive(sessionId) {
    ...
    static async appendAssistantTranscript(sessionId, text, tags = []) {
    ...
    static async updateHonestyScore(sessionId, honestyScore) {
    ...
    static async markInterrupted(sessionId, reason) {
