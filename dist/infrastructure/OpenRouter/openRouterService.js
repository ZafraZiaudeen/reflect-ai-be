...
export const generateTruthReport = async ({ selectedModel, transcriptSegments, interventions, previousSummary, }) => {
        ...
        try {
            const payload = (await client.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'You generate direct but professional couples-session truth reports. Avoid abuse, diagnosis, or threats. Return only valid JSON.',
                    },
                    {
                        role: 'user',
