...
import {
  getHuggingFaceRuntimeStatus,
  getMongoRuntimeStatus,
  getVoiceWebSocketRuntimeStatus,
} from '../infrastructure/Runtime/runtimeStatus.js';
...
apiRouter.get('/health', (_request, response) => {
  ...
  const huggingFaceStatus =
    huggingFace.lastEmbeddingFailureType || huggingFace.lastClassificationFailureType
      ? 'degraded'
